#pragma warning (push)
#pragma warning (disable : 4267 4018 4389 4189 4309 4800 4244 4805 4018 4706 4701 4996 4715)
...
int CompoundFile::WriteFile(const char* path, const char* data, size_t size)
{
	size_t pathLength = strlen(path);
	wchar_t* wpath = new wchar_t[pathLength+1];
	mbstowcs(wpath, path, pathLength);
...
int CompoundFile::WriteFile(const char* path, const vector<char>& data, size_t size)
{
	size_t pathLength = strlen(path);
	wchar_t* wpath = new wchar_t[pathLength+1];
	mbstowcs(wpath, path, pathLength);
